...
namespace MortensKomeback
{
    public class GameWorld : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            #region Add enemies
            gameObjects.Add(new Enemy(new Vector2(1000, 1050)));
            gameObjects.Add(new Enemy(new Vector2(2500, 1050)));
            gameObjects.Add(new Enemy(new Vector2(5444, -1330)));
            gameObjects.Add(new Enemy(new Vector2(7370, 1050)));
            gameObjects.Add(new Enemy(new Vector2(8291, 1050)));
            gameObjects.Add(new Enemy(new Vector2(9234, 1050)));
            gameObjects.Add(new Enemy(new Vector2(10632, 1050)));
            gameObjects.Add(new Enemy(new Vector2(12071, -340)));
            gameObjects.Add(new Enemy(new Vector2(12231, 820)));
            gameObjects.Add(new Enemy(new Vector2(14446, 1050)));
            gameObjects.Add(new Enemy(new Vector2(15494, 1050)));
            gameObjects.Add(new Enemy(new Vector2(16078, 1050)));
            ...
            gameObjects.Add(new Enemy(new Vector2(25591, 1050)));
            gameObjects.Add(new Enemy(new Vector2(26403, 1050)));
            ...
            gameObjects.Add(new Enemy(new Vector2(34356, 1050)));
            gameObjects.Add(new Enemy(new Vector2(34586, 1050)));
            gameObjects.Add(new Enemy(new Vector2(34807, 1050)));
